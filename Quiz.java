...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        this.questions[9][0] = "The Object is created in which memory ?";
        this.questions[9][1] = "Heap";
        this.questions[9][2] = "Stack";
        this.questions[9][3] = "Code";
        this.questions[9][4] = "Data";
